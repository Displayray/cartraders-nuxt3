...
<template>
    <div
        ...
        <input type="text" class="py-3 px-5 w-full text-2xl rounded-l-full focus:outline-none"
            :class="cityError ? 'border-red-500 border-2' : ''" placeholder="Search by city..." v-model="city" />
